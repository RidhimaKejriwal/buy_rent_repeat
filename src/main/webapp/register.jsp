        ...
        <div class="modal-content">
            ...
            <div class="modal-body">  
                <form class="form-group" action="RegisterServlet" method="post">
                    <div class="mb-3">
                        <label for="exampleInputSelect" class="form-label">Select Register Type</label>
                    ...
                    <div class="mb-3">
                        ...
                        <input name="name" type="text" class="form-control" id="name" placeholder="Enter Here.." aria-describedby="emailHelp">                        
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="address" class="form-control" placeholder="Enter here.."></textarea>                        
                    </div>
                    <div class="mb-3">
                        <label for="city" class="form-label">Enter City </label>
                        <input name="city" type="text" class="form-control" id="city" placeholder="Enter Here.." aria-describedby="emailHelp">                        
                    </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn custom-bg checkout-btn text-white">Register</button>
            </div>
        </div>
    </div>
</div>
